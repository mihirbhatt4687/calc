...
const moment = moment__WEBPACK_IMPORTED_MODULE_6__["defaultFormat"] || moment__WEBPACK_IMPORTED_MODULE_6__;
const MY_FORMATS = {
    parse: {
        dateInput: 'LL',
    },
...
let AddExpenseComponent = class AddExpenseComponent {
    constructor(api, datePipe, formBuilder) {
        this.api = api;
...
let ApiService = class ApiService {
    constructor(http) {
        ...
        this.isLogin(localStorage.getItem('user')).subscribe((res) => {
    ...
    addExpense(title, amount, edate, fileToUpload) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json'
        });
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
    ...
    updateExpense(id, title, amount, edate, fileToUpload) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json'
        });
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
    ...
    loadExpense(searchText, startDate, endDate) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('token', localStorage.getItem('user'))
...
let AppComponent = class AppComponent {
    constructor(api, httpClient, router) {
        this.api = api;
...
let EditExpenseComponent = class EditExpenseComponent {
    constructor(api, datePipe, activatedRoute) {
        this.api = api;
        this.datePipe = datePipe;
    ...
    ngOnInit() {
        ...
        this.api.editExpense(this.expenseId).subscribe((res) => {
            this.title = res.title;
            this.amount = res.amount;
            this.edate = new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](moment__WEBPACK_IMPORTED_MODULE_6__(res.edate, 'DD-MM-YYYY'));
            this.doc = res.doc;
        });
    }
    updateExpense() {
        if (typeof this.title === 'undefined' || typeof this.amount === 'undefined' || typeof this.edate === 'undefined') {
            ...
            const yyyy = tmpDate.getFullYear();
            const today = dd + '.' + mm + '.' + yyyy;
            this.api.updateExpense(this.expenseId, this.title, this.amount, today, this.fileToUpload).subscribe((res) => {
...
const moment = moment__WEBPACK_IMPORTED_MODULE_5__["defaultFormat"] || moment__WEBPACK_IMPORTED_MODULE_5__;
const MY_FORMATS = {
    parse: {
        dateInput: 'LL',
    },
...
let ExpenseComponent = class ExpenseComponent {
    ...
    loadExpense() {
        ...
        this.api.loadExpense(searchText, startDate, endDate).subscribe((res) => {
...
let HomeComponent = class HomeComponent {
    ...
    doLogin() {
        ...
        this.api.doLogin(this.email, this.password).subscribe((res) => {
            if (res.login !== '') {
...
let ReportComponent = class ReportComponent {
    ...
    generateReport() {
        ...
        this.total = 0;
        this.api.reportExpense(mon, this.date.value.year()).subscribe((res) => {
            this.config.totalItems = this.collection.count = res.count;
            for (let i = 0; i < this.collection.count; i++) {
                this.collection.data.push({
                    id: i + 1,
